...
<link rel="stylesheet" type="text/css" href="css/fundAnalysis.css">
...
<body>
            ...
            <div class="content-center">
                <div class="balance">
                    <div id="selectDiv">
                        ...
                        <span>收入<b></b></span>
                        <span>支出<b id="pay"></b></span>
                    </div>
                    <canvas id="canvas1" height="250" width="250"></canvas>
                    <canvas id="canvas2" height="270" width="470"></canvas>
                </div>
    ...
    <script src="js/fundAnalysis.js" type="text/javascript"></script>
</body>
</html>