    ...
    <div id="top-right">
        ...
        <p>
            欢迎您，尊敬的<b>&nbsp;&nbsp;${user.userName}</b> <span> &nbsp;&nbsp;<a
                ...
                href="toProblem_redirection.do">个人中心</a>&nbsp;| &nbsp;&nbsp;<a
                ...
                <div class="balance">
                	<form action="#">
                        ...
                        <h3>
                            ...
                            <span>
                            1月
                            <input type="radio" name="" class="radio" value="1">
                            6月
                            <input type="radio" name="" class="radio" value="6">
                            12月
                            <input type="radio" name="" class="radio" value="12">
                            </span>
                        </h3>
                        <h3>
                    	    <button>闪电借款</button>
