        ...
        <div class="content">
            <div class="content-top">
                <ul>
                    ...
                    <li><a href="fundAnalysis_genius.do">资金分析
                    </a></li>
                    <li><a href="toCardManage_redirection.do">银行卡管理
                    </a></li>
                    <li><a href=" ">安全中心
                    </a></li>
                    <li><a href=" ">马上借呗
            ...
            <div class="content-show">${prompt}</div>
            <div class="content-center">
                <div class="balance">
                    <p>
                        总余额(元)：<br>${userBalance}
                    </p>
                    <div class="operation">
                        <a href="toRechange_redirection.do" id="rechange">充值</a> 
                        <a href="toWithdraw_redirection.do" id="withdraw">提现</a>
                    </div>
                </div>
                <div class="profit">
                    <p>
